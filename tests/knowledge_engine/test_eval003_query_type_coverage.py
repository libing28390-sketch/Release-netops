"""EVAL-003 Knowledge Engine query-type boundary gate; no database fixture is used."""
...
_SCRIPT = Path(__file__).parents[2] / "scripts" / "knowledge_eval_query_type_coverage_check.py"
