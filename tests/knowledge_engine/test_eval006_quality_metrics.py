"""EVAL-006 Knowledge Engine quality-metric gate; no database fixture is used."""
...
_SCRIPT = Path(__file__).parents[2] / "scripts" / "knowledge_eval_quality_metrics_check.py"
