"""EVAL-008 Golden Answer workflow gate; no database fixture is used."""
...
_SCRIPT = Path(__file__).parents[2] / "scripts" / "knowledge_engine_v2_eval_golden_annotation_check.py"
