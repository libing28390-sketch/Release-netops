"""EVAL-002 coverage gate; this fixture test has no database dependency."""
...
_SCRIPT = Path(__file__).parents[2] / "scripts" / "knowledge_engine_v2_eval_intent_coverage_check.py"
