"""EVAL-001 frozen dataset gate; no SQLite or database fixture is involved."""
...
_SCRIPT = Path(__file__).parents[2] / "scripts" / "knowledge_engine_v2_eval_dataset_check.py"
