...
const ROLE_LEVEL: Record<string, number> = { Administrator: 3, Operator: 2, Viewer: 1 };
  ...
  const appEntries = useMemo(() => [
    ...
    { id: 'automation', label: '自动化',     labelEn: 'Automation',   icon: Zap,               path: '/automation/quick-ops',   accent: '#0891b2', minRole: 'Viewer' },
    ...
    { id: 'ai',         label: 'AI 中心',    labelEn: 'AI Center',    icon: Bot,               path: '/ai/providers',       accent: '#6366f1', minRole: 'Viewer' },
  ], []);
