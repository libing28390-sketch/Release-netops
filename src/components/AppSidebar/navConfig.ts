...
export const navConfig: NavGroup[] = [
  {
    ...
    children: [
      ...
      { id: 'monitoring-dashboards', label: '监控大盘', labelEn: 'Monitoring Dashboards', path: '/monitor/dashboards', icon: 'BarChart2' },
      { id: 'snmp-walk', label: 'SNMP 诊断', labelEn: 'SNMP Diagnostics', path: '/monitor/snmp-walk', icon: 'Search', requiredRole: 'Operator' },
      {
        id: 'monitoring-reports',
        label: '监控报表',
        labelEn: 'Monitoring Reports',
        path: '/monitor/reports/interfaces',
        activeMatch: '/monitor/reports',
        icon: 'FileSpreadsheet',
        children: [
          { id: 'reports-interfaces', label: '全网接口流量与利用率', labelEn: 'Interface Traffic & Util', path: '/monitor/reports/interfaces', activeMatch: '/monitor/reports/interfaces,/monitor/reports', icon: 'Activity' },
          { id: 'reports-devices',    label: '网络设备运行与资源',   labelEn: 'Device Load & Resources', path: '/monitor/reports/devices',    icon: 'Server' },
          { id: 'reports-outbound',   label: '互联网出口与 WAN 链路', labelEn: 'Outbound & WAN Probes',   path: '/monitor/reports/outbound',   icon: 'Globe' },
        ],
      },
      { id: 'monitoring-collectors', label: '采集器管理', labelEn: 'Collectors', path: '/monitor/collectors', icon: 'CloudCog', requiredRole: 'Operator' },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'access-favorites', label: '我的收藏',     labelEn: 'My Favorites',         path: '/access/favorites',  icon: 'Star' },
      { id: 'access-history',   label: '我的历史记录', labelEn: 'My History',           path: '/access/history',    icon: 'History' },
  ...
  },
  {
    ...
    icon: 'Zap',
    children: [
      { id: 'auto-exec',           label: '快捷操作',   labelEn: 'Quick Operations',     path: '/automation/quick-ops', activeMatch: '/automation/quick-ops,/automation/tasks,/automation/execute,/automation/playbooks,/automation/scenarios', icon: 'Zap' },
      ...
      { id: 'textfsm-templates',   label: '解析模板',   labelEn: 'Parse Templates',      path: '/automation/textfsm',             icon: 'FileCode2', requiredRole: 'Operator' },
      {
        ...
        activeMatch: '/automation/scripts,/automation/nsot',
        icon: 'Code2',
        requiredRole: 'Operator',
        children: [
          { id: 'script-operations', label: '脚本 / 系统操作', labelEn: 'Scripts / system operations', path: '/automation/scripts', icon: 'FileCode2', requiredRole: 'Operator' },
          { id: 'nsot-operations', label: 'NSOT 采集目录', labelEn: 'NSOT collection catalog', path: '/automation/nsot', icon: 'Terminal', requiredRole: 'Operator' },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'ai-health',     label: '健康与 SLA',     labelEn: 'Health & SLA', path: '/ai/health',      icon: 'Activity', requiredRole: 'Administrator' },
...

  {
    ...
    children: [
      ...
      { id: 'email-settings', label: '邮件通知', labelEn: 'Email Notifications', icon: 'Bell', path: '/management/notifications', requiredRole: 'Administrator' },
      { id: 'storage',      label: '对象存储', labelEn: 'Object Storage',     icon: 'CloudCog', path: '/management/storage', requiredRole: 'Administrator' },
    ],
  },
];
