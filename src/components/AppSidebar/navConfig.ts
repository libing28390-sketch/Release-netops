...
export const navConfig: NavGroup[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'devices',    label: '网络设备',    labelEn: 'Network Devices', path: '/assets/devices',     icon: 'Router' },
      ...
      { id: 'ip-locator', label: 'IP 工具箱',   labelEn: 'IP Toolbox',      path: '/assets/toolbox',     icon: 'MapPin' },
