...
export const navConfig: NavGroup[] = [
  ...
  },
  {
    ...
    labelEn: 'PLATFORM REGISTRY',
    icon: 'Settings',
    section: true,
    children: [
      { id: 'platform-registry-entry', label: 'Platform Registry', labelEn: 'Platform Registry', path: '/management/platforms', icon: 'Settings', requiredRole: 'Viewer' },
    ],
  },
];
