...
const MonitoringReportsPage = lazy(() => import('../pages/MonitoringReportsPage'));
const MonitoringManagementPage = lazy(() => import('./MonitoringManagementPage.tsx'));
...
const NotificationChannelSettingsPage = lazy(() => import('../pages/NotificationChannelSettingsPage'));
const SnmpWalkPage = lazy(() => import('../pages/SnmpWalkPage'));
...
const AppMainContent: React.FC = () => {
  ...
  return (
    <main className={mainClassName}>
      ...
      {activeTab === 'network-monitoring' && (
        <Suspense fallback={lazyPanelFallback}>
          <NetworkMonitoring
            ...
            onOpenSnmpWalk={(device) => navigate(`/monitor/snmp-walk?ip=${encodeURIComponent(device.ip_address || '')}`)}
          />
        </Suspense>
      )}
      ...
      {activeTab === 'monitoring-dashboards' && (
        <Suspense fallback={lazyPanelFallback}>
          <GrafanaDashboardPage language={language} />
        </Suspense>
      )}

      {activeTab === 'monitoring-reports' && (
        <Suspense fallback={lazyPanelFallback}>
          <MonitoringReportsPage language={language as 'zh' | 'en'} />
        </Suspense>
      )}
      ...
      {activeTab === 'monitoring-plans' && (
        <Suspense fallback={lazyPanelFallback}>
          <MonitoringManagementPage language={language} mode="plans" showToast={showToast} />
        </Suspense>
      )}

      {activeTab === 'monitoring-modules' && (
        <Suspense fallback={lazyPanelFallback}>
          <MonitoringManagementPage language={language} mode="modules" showToast={showToast} />
        </Suspense>
      )}

      {activeTab === 'monitoring-collectors' && (
        <Suspense fallback={lazyPanelFallback}>
          <MonitoringManagementPage language={language} mode="collectors" showToast={showToast} />
        </Suspense>
      )}

      {activeTab === 'monitoring-health' && (
        <Suspense fallback={lazyPanelFallback}>
          <MonitoringManagementPage language={language} mode="health" showToast={showToast} />
        </Suspense>
      )}
      ...
      {activeTab === 'topology' && (
        <Suspense fallback={lazyPanelFallback}>
          <TopologyPage
            ...
            hostnameSyncing={hostnameSyncing}
      ...
      {activeTab === 'automation' && (automationPage === 'scripts' || automationPage === 'nsot') && (
        <Suspense fallback={lazyPanelFallback}>
          <ScriptManagementTab language={language} showToast={showToast} view={automationPage === 'nsot' ? 'nsot' : 'scripts'} />
        </Suspense>
      )}
      ...
      {activeTab === 'storage' && (
        <Suspense fallback={lazyPanelFallback}>
          <StorageManagementPage language={language} currentUser={currentUser} />
        </Suspense>
      )}

      {activeTab === 'email-settings' && (
        <Suspense fallback={lazyPanelFallback}>
          <NotificationChannelSettingsPage language={language} showToast={showToast} />
        </Suspense>
      )}
