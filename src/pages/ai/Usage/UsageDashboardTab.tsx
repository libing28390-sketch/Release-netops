      ...
      <section className="relative overflow-hidden rounded-[26px] border border-indigo-100/80 bg-gradient-to-br from-white via-indigo-50/70 to-cyan-100/60 px-5 py-6 shadow-sm shadow-indigo-100/50 dark:border-indigo-900/60 dark:from-slate-900 dark:via-indigo-950/40 dark:to-slate-900 dark:shadow-none sm:px-7 sm:py-7">
        ...
        <div className="relative flex flex-col justify-between gap-6 xl:flex-row xl:items-center">
          <div className="max-w-3xl">
            ...
            <h2 className="flex items-center gap-3 text-2xl font-bold tracking-tight text-slate-950 dark:text-white sm:text-[28px]"><span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-indigo-600 text-white shadow-lg shadow-indigo-600/25"><Activity className="h-6 w-6" /></span>{zh ? 'Token 使用统计与 AI 审计' : 'Token Usage & AI Audit'}</h2>
            <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600 dark:text-slate-300">{zh ? '把每次 AI 请求的用量、延迟、状态和发起方放在同一个可追溯视图中。用户列会区分登录用户、会话用户和匿名请求。' : 'Track usage, latency, status, and request actors in one auditable view. The user column distinguishes signed-in, session, and anonymous requests.'}</p>
          </div>
