...
import { RackAssetFrame } from './RackAssetFrame';
  ...
  return (
    <div className="w-full h-full relative select-none">
      ...
      >
        ...
        <pointLight position={[0, centerY, 14]} intensity={1.8} color="#e2e8f0" distance={30} />
        ...
        <Grid
          // Leave room below the plinth for the visible caster wheels and
          // their leveling feet; the old floor plane intersected the wheel
          // rings and made them disappear in the GLB view.
          position={[0, -1.08, 0]}
          args={[60, 60]}
          cellSize={1}
          cellThickness={0.6}
        ...
        <RackCableLayer
          ...
          cableMode={cableMode}
          links={topologyLinks}
          showPreviewWhenEmpty={showPreviewCables}
        />
      </Canvas>
    </div>
  );
