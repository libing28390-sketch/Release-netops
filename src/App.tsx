...
const App: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    const redirects: Record<string, string> = {
      ...
      '/platforms': '/management/platforms',
    };
    if (p === '/ipam') {
  ...
  const topologyValue = {
    ...
    topologySearch, topologySiteFilter, topologyTagFilter, topologyRoleFilter, topologyStatusFilter,
    ...
    setTopologySearch, setTopologySiteFilter, setTopologyTagFilter, setTopologyRoleFilter, setTopologyStatusFilter,
