---
schema_version: '2.0'
document_id: local.huawei.huawei_vrp.ospf.v1
title: Huawei VRP OSPF 邻居与区域配置（本地官网摘要）
vendor: Huawei
...
rag_priority: 75
source_url: https://support.huawei.com/enterprise/en/doc/EDOC1100459053/e1fd2273/example-for-configuring-ospf-multi-area-adjacency
source_urls:
- https://support.huawei.com/enterprise/en/doc/EDOC1100459053/e1fd2273/example-for-configuring-ospf-multi-area-adjacency
...
# Huawei VRP OSPF 邻居与区域配置（本地官网摘要）
...
来源页面用于 Huawei OSPF 的候选证据。具体型号、软件版本、板卡能力和命令参数必须在目标设备的版本化命令参考中复核。
