---
schema_version: '2.0'
document_id: local.huawei.huawei_vrp.lacp.v1
title: Huawei VRP LACP 链路聚合配置与验证（本地官网摘要）
vendor: Huawei
...
rag_priority: 75
source_url: https://support.huawei.com/enterprise/en/doc/EDOC1100368579/b7014cbe/eth-trunk-configuration-commands
source_urls:
- https://support.huawei.com/enterprise/en/doc/EDOC1100368579/b7014cbe/eth-trunk-configuration-commands
...
# Huawei VRP LACP 链路聚合配置与验证（本地官网摘要）
...
来源页面用于 Huawei 链路聚合 的候选证据。具体型号、软件版本、板卡能力和命令参数必须在目标设备的版本化命令参考中复核。
