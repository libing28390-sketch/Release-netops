---
schema_version: '2.0'
document_id: local.huawei.huawei_vrp.bgp.v1
title: Huawei VRP BGP 邻居与路由发布配置（本地官网摘要）
vendor: Huawei
...
rag_priority: 75
source_url: https://support.huawei.com/enterprise/en/doc/EDOC1100313446/5829dca4/bgp-peer-relationship-fails-to-be-established
source_urls:
- https://support.huawei.com/enterprise/en/doc/EDOC1100313446/5829dca4/bgp-peer-relationship-fails-to-be-established
...
# Huawei VRP BGP 邻居与路由发布配置（本地官网摘要）
...
来源页面用于 Huawei BGP 的候选证据。具体型号、软件版本、板卡能力和命令参数必须在目标设备的版本化命令参考中复核。
