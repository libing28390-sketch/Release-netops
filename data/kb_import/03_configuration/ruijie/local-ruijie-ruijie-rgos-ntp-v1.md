---
schema_version: '2.0'
document_id: local.ruijie.ruijie_rgos.ntp.v1
title: Ruijie RGOS NTP 时间同步配置与验证（本地官网摘要）
vendor: Ruijie
...
rag_priority: 75
source_url: https://www.ruijie.com.cn/fw/wt/18858/
source_urls:
- https://www.ruijie.com.cn/fw/wt/18858/
...
# Ruijie RGOS NTP 时间同步配置与验证（本地官网摘要）
...
来源页面用于 Ruijie NTP 的候选证据。具体型号、软件版本、板卡能力和命令参数必须在目标设备的版本化命令参考中复核。
