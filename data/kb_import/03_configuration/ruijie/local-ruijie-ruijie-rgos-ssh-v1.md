---
schema_version: '2.0'
document_id: local.ruijie.ruijie_rgos.ssh.v1
title: Ruijie RGOS SSH/安全管理登录配置（本地官网摘要）
vendor: Ruijie
...
rag_priority: 75
source_url: https://www.ruijie.com.cn/fw/wt/35612/
source_urls:
- https://www.ruijie.com.cn/fw/wt/35612/
...
# Ruijie RGOS SSH/安全管理登录配置（本地官网摘要）
...
来源页面用于 Ruijie SSH 的候选证据。具体型号、软件版本、板卡能力和命令参数必须在目标设备的版本化命令参考中复核。
