---
schema_version: '2.0'
document_id: local.cisco.cisco_iosxe.ntp.v1
title: Cisco IOS-XE NTP 时间同步配置与验证（本地官网摘要）
vendor: Cisco
...
rag_priority: 75
source_url: https://www.cisco.com/c/en/us/td/docs/routers/ios/config/17-x/syst-mgmt/b-system-management/m_bsm-time-calendar-set.html
source_urls:
...
# Cisco IOS-XE NTP 时间同步配置与验证（本地官网摘要）
...
来源页面用于 Cisco NTP 的候选证据。具体型号、软件版本、板卡能力和命令参数必须在目标设备的版本化命令参考中复核。
