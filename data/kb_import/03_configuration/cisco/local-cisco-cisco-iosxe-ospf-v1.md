---
schema_version: '2.0'
document_id: local.cisco.cisco_iosxe.ospf.v1
title: Cisco IOS-XE OSPF 邻居与区域配置（本地官网摘要）
vendor: Cisco
...
# Cisco IOS-XE OSPF 邻居与区域配置（本地官网摘要）
...
来源页面用于 Cisco OSPF 的候选证据。具体型号、软件版本、板卡能力和命令参数必须在目标设备的版本化命令参考中复核。
