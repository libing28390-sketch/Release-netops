---
schema_version: '2.0'
document_id: local.cisco.iosxe.aaa_authentication.v1
title: Cisco IOS-XE AAA 登录认证与本地回退配置摘要
vendor: Cisco
...
feature: pam
subfeature: aaa_login_fallback
risk_level: medium
verification_level: official_reference_source_checked
rag_priority: 75
source_url: https://www.cisco.com/c/en/us/td/docs/switches/lan/catalyst9300/software/release/17-13/configuration_guide/sec/b_1713_sec_9300_cg/configuring_authentication.html
source_urls:
- https://www.cisco.com/c/en/us/td/docs/switches/lan/catalyst9300/software/release/17-13/configuration_guide/sec/b_1713_sec_9300_cg/configuring_authentication.html
...
# Cisco IOS-XE AAA 登录认证与本地回退配置摘要
...
Cisco Catalyst 9300 IOS-XE 官方认证指南覆盖 AAA 登录认证方法列表以及 TACACS+ 到本地 的回退关系；服务器组、授权策略、VTY 应用范围和软件版本必须按目标设备配置复核， 变更前要保留带外登录与回滚路径。
