---
schema_version: '2.0'
document_id: local.cisco.cisco_iosxe.lacp.v1
title: Cisco IOS-XE LACP 链路聚合配置与验证（本地官网摘要）
vendor: Cisco
...
# Cisco IOS-XE LACP 链路聚合配置与验证（本地官网摘要）
...
来源页面用于 Cisco 链路聚合 的候选证据。具体型号、软件版本、板卡能力和命令参数必须在目标设备的版本化命令参考中复核。
