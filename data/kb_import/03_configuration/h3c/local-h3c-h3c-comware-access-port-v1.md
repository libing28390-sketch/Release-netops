---
schema_version: '2.0'
document_id: local.h3c.h3c_comware.access_port.v1
title: H3C Comware Access 接入口配置与验证（本地官网摘要）
vendor: H3C
...
# H3C Comware Access 接入口配置与验证（本地官网摘要）
...
来源页面用于 H3C Access 端口 的候选证据。具体型号、软件版本、板卡能力和命令参数必须在目标设备的版本化命令参考中复核。
