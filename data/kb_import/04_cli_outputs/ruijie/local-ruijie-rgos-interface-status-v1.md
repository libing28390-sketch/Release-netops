---
schema_version: '2.0'
document_id: local.ruijie.rgos.interface_status.v1
title: Ruijie RGOS 接口状态核验摘要
vendor: Ruijie
...
rag_priority: 85
source_url: https://www.ruijie.com.cn/fw/wt/35641/
source_urls:
- https://www.ruijie.com.cn/fw/wt/35641/
- https://www.ruijie.com.cn/fw/wt/18515/
...
先用 show interface status 确认接口名称和链路状态，再核对 VLAN/聚合成员； 设备系列和 RGOS 版本不同可能使用不同的复数或过滤参数。
