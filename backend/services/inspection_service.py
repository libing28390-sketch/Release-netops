...
_NETWORK_PLATFORMS = {
    ...
    'h3c_comware', 'h3c_comware9', 'hp_comware',
...
def _netmiko_collect(device: dict[str, Any], commands: list[str], use_admin_creds: bool = False) -> dict[str, str]:
    ...
    is_slow = platform in {'huawei_vrp', 'huawei_vrpv8', 'h3c_comware', 'h3c_comware9', 'hp_comware'}
...
def _load_devices(conn, scope_type: str, scope_filter: str) -> list[dict[str, Any]]:
    select = (
        ...
        'credential_source, vault_path, snmp_community, snmp_port, collection_policy_json'
    )
    if scope_type == 'all':
