...
ACTION_DEFINITIONS: tuple[dict[str, Any], ...] = (
    ...
    {"action_code": "get_startup_config", "name_zh": "启动配置", "name_en": "Startup Configuration", "purpose": "启动配置备份和审计", "risk": "sensitive", "consumers": ["configuration", "inspection"], "fields": ["configuration"], "max_records": 1},
)
...
PLATFORM_ACTION_COMMANDS: dict[str, dict[str, str]] = {
    ...
    "dptech_ios": {"get_version": "display version", "get_lldp_neighbors": "display lldp neighbor brief", "get_interface_brief": "display interface brief", "get_ip_interfaces": "display ip interface brief", "get_arp_table": "display arp all", "get_mac_table": "display mac-address", "get_vlan_table": "display vlan", "get_route_table": "display ip routing-table", "get_isis_neighbors": "display isis peer", "get_stp": "display stp brief", "get_cpu": "display cpu-usage", "get_memory": "display memory", "get_clock": "display clock", "get_running_config": "display current-configuration", "get_startup_config": "display saved-configuration"},
...
def platform_codes_match(device_platform: Any, profile_platform: Any, parser_platform: Any = None) -> bool:
    ...
    candidates = {
        "h3c_comware" if value in {"h3c", "comware", "h3c_comware", "h3c_comware_v5", "h3c_comware_v7", "h3c_comware_v9"} else value
