...
_PLATFORM_ALIASES = {
    ...
    "h3c": "h3c_comware", "h3c_comware9": "h3c_comware", "comware": "h3c_comware", "hp_comware": "h3c_comware",
...
def normalize_neighbor_record(record: dict[str, Any], *, protocol: str = "lldp") -> dict[str, Any]:
    ...
    capabilities = first("neighbor_capabilities", "capabilities")
    ...
    return {
        ...
        "neighbor_name": first("neighbor_name", "neighbor", "neighbor_id", "remote_system_name", "system_name"),
