...
PLATFORM_PROFILES: dict[str, tuple[dict[str, object], ...]] = {
    "raisecom_ros": (
        {"series": "ISCOM S5600-EI", "model_patterns": (r"^(?:ISCOM\s*)?S5600(?:-28C-EI)?",), "roles": ("switch",)},
    ),
    "ruijie_rgos": (
...
_PLATFORM_ALIASES = {
    ...
    "瑞斯康达 ros": "raisecom_ros",
    "raisecom_ros5": "raisecom_ros",
    "raisecom ros 5.2": "raisecom_ros",
    "mypower": "maipu",
