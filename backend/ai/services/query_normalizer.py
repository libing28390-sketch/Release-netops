"""Deterministic Query Normalizer contract for Knowledge Engine V2.
...
_VERSION_RE = re.compile(r"(?i)\b(?:V\d{3,4}(?:R\d+[A-Z]?\d*)?|\d+\.\d+(?:\.\d+){0,2})\b")
