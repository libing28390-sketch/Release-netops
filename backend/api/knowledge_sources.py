"""HTTP API for the Knowledge Engine V1 Source Registry (CAT-003)."""
...
from api.knowledge_response import (
...
router = APIRouter(prefix="/knowledge/sources", tags=["knowledge-source-registry"])
